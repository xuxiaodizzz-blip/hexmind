    ...
    <div className="flex-1 overflow-y-auto no-scrollbar p-8 lg:p-12 z-10 w-full bg-[#0b0f17] text-white">
      <div className="max-w-6xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-10">
          <h1 className="text-4xl font-bold font-sans mb-2 tracking-tight">{t('analytics.title')}</h1>
          <p className="text-white/50 font-serif italic text-lg">{t('analytics.subtitle')}</p>
        </motion.div>
        ...
        >
          ...
          <h2 className="text-2xl font-bold font-sans mb-3">{t('analytics.emptyTitle')}</h2>
