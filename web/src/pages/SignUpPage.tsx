  ...
  return (
    <div className="min-h-screen bg-[#0b0f17] flex items-center justify-center px-4 relative">
      ...
      <div className="relative z-10 flex flex-col items-center gap-4">
        {/* Turnstile challenge — invisible until solved */}
        <TurnstileWidget onVerified={setTurnstileOk} />

        {/* Block the Clerk UI until Turnstile passes */}
        {!turnstileOk ? (
          <div className="text-white/40 text-sm py-4">Verifying…</div>
        ) : (
          <SignUp
            routing="path"
            path="/sign-up"
